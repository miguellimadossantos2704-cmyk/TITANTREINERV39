...
// Base de Alimentos Titan - Foco em Ectomorfos (Sem Lactose)
// Base de Alimentos Titan - Multi-idioma
const foodDatabase = {
    pt: [
        { name: "Arroz Integral (100g)", kcal: 130, prot: 2.6, carb: 28, fat: 0.3 },
        { name: "Peito de Frango Grelhado (100g)", kcal: 165, prot: 31, carb: 0, fat: 3.6 },
        { name: "Batata Doce Cozida (100g)", kcal: 86, prot: 1.6, carb: 20, fat: 0.1 },
        { name: "Ovo Cozido (Unidade)", kcal: 78, prot: 6.3, carb: 0.6, fat: 5.3 },
        { name: "Banana Prata (Unidade)", kcal: 89, prot: 1.1, carb: 23, fat: 0.3 },
        { name: "Pasta de Amendoim (100g)", kcal: 588, prot: 25, carb: 20, fat: 50 },
        { name: "Tilápia Grelhada (100g)", kcal: 128, prot: 26, carb: 0, fat: 2.7 },
        { name: "Aveia em Flocos (100g)", kcal: 394, prot: 14, carb: 67, fat: 8.5 },
        { name: "Azeite de Oliva (Colher)", kcal: 119, prot: 0, carb: 0, fat: 14 }
    ],
    en: [
        { name: "Brown Rice (100g)", kcal: 130, prot: 2.6, carb: 28, fat: 0.3 },
        { name: "Grilled Chicken Breast (100g)", kcal: 165, prot: 31, carb: 0, fat: 3.6 },
        { name: "Boiled Sweet Potato (100g)", kcal: 86, prot: 1.6, carb: 20, fat: 0.1 },
        { name: "Boiled Egg (Unit)", kcal: 78, prot: 6.3, carb: 0.6, fat: 5.3 },
        { name: "Banana (Unit)", kcal: 89, prot: 1.1, carb: 23, fat: 0.3 },
        { name: "Peanut Butter (100g)", kcal: 588, prot: 25, carb: 20, fat: 50 },
        { name: "Grilled Tilapia (100g)", kcal: 128, prot: 26, carb: 0, fat: 2.7 },
        { name: "Oat Flakes (100g)", kcal: 394, prot: 14, carb: 67, fat: 8.5 },
        { name: "Olive Oil (Tbsp)", kcal: 119, prot: 0, carb: 0, fat: 14 }
    ],
    es: [
        { name: "Arroz Integral (100g)", kcal: 130, prot: 2.6, carb: 28, fat: 0.3 },
        { name: "Pechuga de Pollo (100g)", kcal: 165, prot: 31, carb: 0, fat: 3.6 },
        { name: "Batata Cocida (100g)", kcal: 86, prot: 1.6, carb: 20, fat: 0.1 },
        { name: "Huevo Cocido (Unidad)", kcal: 78, prot: 6.3, carb: 0.6, fat: 5.3 },
        { name: "Banana (Unidad)", kcal: 89, prot: 1.1, carb: 23, fat: 0.3 },
        { name: "Mantequilla de Maní (100g)", kcal: 588, prot: 25, carb: 20, fat: 50 },
        { name: "Tilapia a la Plancha (100g)", kcal: 128, prot: 26, carb: 0, fat: 2.7 },
        { name: "Avena en Copos (100g)", kcal: 394, prot: 14, carb: 67, fat: 8.5 },
        { name: "Aceite de Oliva (Cda)", kcal: 119, prot: 0, carb: 0, fat: 14 }
    ],
    jp: [
        { name: "玄米 (100g)", kcal: 130, prot: 2.6, carb: 28, fat: 0.3 },
        { name: "グリルチキン (100g)", kcal: 165, prot: 31, carb: 0, fat: 3.6 },
        { name: "ゆでさつまいも (100g)", kcal: 86, prot: 1.6, carb: 20, fat: 0.1 },
        { name: "ゆで卵 (1個)", kcal: 78, prot: 6.3, carb: 0.6, fat: 5.3 },
        { name: "バナナ (1本)", kcal: 89, prot: 1.1, carb: 23, fat: 0.3 },
        { name: "ピーナッツバター (100g)", kcal: 588, prot: 25, carb: 20, fat: 50 },
        { name: "ティラピアのグリル (100g)", kcal: 128, prot: 26, carb: 0, fat: 2.7 },
        { name: "オートミール (100g)", kcal: 394, prot: 14, carb: 67, fat: 8.5 },
        { name: "オリーブオイル (大さじ)", kcal: 119, prot: 0, carb: 0, fat: 14 }
    ]
};

// Sugestoes UI
const suggestionBox = document.createElement('div');
suggestionBox.id = 'food-suggestions';
...
`;
document.getElementById('food-name').parentNode.style.position = 'relative'; // Ensure parent is relative
document.getElementById('food-name').parentNode.appendChild(suggestionBox);

// Função para buscar na base enquanto digita
document.getElementById('food-name').addEventListener('input', (e) => {
    ...
    // Detect Language
    const lang = localStorage.getItem('titanLanguage') || 'pt';
    const currentDB = foodDatabase[lang] || foodDatabase['pt'];

    if (term.length > 2) {
        const matches = currentDB.filter(f => f.name.toLowerCase().includes(term));
        ...
        if (matches.length > 0) {
            ...
            matches.forEach(food => {
                ...
                div.style.cursor = 'pointer';
                div.style.color = '#fff';
                div.innerHTML = `<span style="color:var(--accent)">${food.name}</span> <small style="color:#666">(${food.kcal}kcal)</small>`;

                div.onclick = () => {
                    document.getElementById('food-name').value = food.name;
                    document.getElementById('food-kcal').value = food.kcal;
                    document.getElementById('food-protein').value = food.prot;
                    document.getElementById('food-carbs').value = food.carb;
